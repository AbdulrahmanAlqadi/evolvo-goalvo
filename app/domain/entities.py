...
class MatchStatistics(BaseModel):
    ...
    passes_home: int | None = Field(default=None, ge=0)
    passes_away: int | None = Field(default=None, ge=0)
    pass_accuracy_home: float | None = Field(default=None, ge=0, le=100)
    pass_accuracy_away: float | None = Field(default=None, ge=0, le=100)
    ...
    fouls_home: int | None = Field(default=None, ge=0)
    fouls_away: int | None = Field(default=None, ge=0)
    yellow_cards_home: int | None = Field(default=None, ge=0)
    yellow_cards_away: int | None = Field(default=None, ge=0)
    offsides_home: int | None = Field(default=None, ge=0)
    offsides_away: int | None = Field(default=None, ge=0)
    saves_home: int | None = Field(default=None, ge=0)
    saves_away: int | None = Field(default=None, ge=0)
